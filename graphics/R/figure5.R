...
o2 = o[[1]]
dim(o2)
# Discard the last million to match the papers discription
o1 = o2[1001:21000,]
...
hist(o1[,6], breaks=40, 
     ylim=c(0, 2500), 
     xlim=c(1.9, 2.5), main=NULL, xlab=expression(alpha[N]), 
     col="grey60", border="white");
add_interval(o1[,6],  2500, text=FALSE)
text(2.45, 2400, "(d)", cex=0.6)


hist(o1[,7], breaks="fd", ylim=c(0, 1000), 
     xlim=c(0, 0.03), main=NULL, xlab=expression(lambda[N]), 
     col="grey60", border="white");
add_interval(o1[,7], 1400)
text(0.028, 950, "(e)", cex=0.6)

hist(o1[,8], breaks=40, ylim=c(0, 3000), 
     xlim=c(0, 0.15), main=NULL, xlab=expression(mu[N]), 
     col="grey60", border="white");
add_interval(o1[,8], 2850)
text(0.14, 2900, "(f)", cex=0.6)
dev.off()
system(paste("pdfcrop", fname))
...
hist(o1[,5], breaks=60, ylim=c(0,800), 
     xlim=c(0, 0.15), main=NULL, xlab=expression(p[U]), 
     col="grey60", border="white");
add_interval(o1[,5],  770)
text(0.15, 780, "(g)", cex=0.6)

hist(o1[,9], breaks=60, ylim=c(0, 1000), 
     xlim=c(0.125, 0.275), main=NULL, xlab=expression(p[N]), 
     col="grey60", border="white");
add_interval(o1[,9],  970)
text(0.275, 990, "(h)", cex=0.6)
dev.off()
system(paste("pdfcrop", fname))
